export default {
  ...
  congratsBtn: 'Congrats',
  teaseBtn: 'Hehe',
  congratsYou: 'congratulated you',
  teasedYou: 'teased you',
  congratsMessage: 'Look at you sleeping early! 🎉',
  teaseMessage: 'Hehe, I see you slept late 😏',
  congratsSentTitle: 'Congrats sent to',
  teaseSentTitle: 'Tease sent to',
  respond: 'Respond',
  dismiss: 'Dismiss',
  repliedYou: 'replied',
